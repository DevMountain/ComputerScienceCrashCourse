...
fileprivate class ConcreteBookParser: IBookParser {
    
    fileprivate var bookArray: [String]
    
    init(book: String) {
        let bookSequence = book.split(separator: " ")
        self.bookArray = bookSequence.compactMap{ String($0) }
    }
    
    fileprivate func getWordCount() -> Int {
...
class LazyProxyBookParser: IBookParser {
    ...
    fileprivate var bookParser: ConcreteBookParser?
    var book: String
